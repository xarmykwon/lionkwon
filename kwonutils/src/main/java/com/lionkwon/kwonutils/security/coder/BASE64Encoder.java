...
public class BASE64Encoder extends CharacterEncoder {
	 ...
	 */
	public final void encodeBuffer(InputStream in, OutputStream out) throws IOException {
	...
	private static final void writeChars(int b1, int b2, int b3, int padding, OutputStream out) throws IOException {
