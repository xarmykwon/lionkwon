...
//		s.getBytes(0, len, b, 0);
	 ...
	 */
	public static int cpybytes(InputStream in, OutputStream out) throws IOException{
		byte[] buf = new byte[1024];
		int n, ntotal = 0;
	 ...
	 * @return    the total number of bytes written to the output stream
	 */
	public static int cpybytes(InputStream in, OutputStream out, int n) throws IOException{
	 ...
	 */
	public static final int indexOf(byte[] buf, int ch, int fromIndex, int toIndex) {
		int i;
